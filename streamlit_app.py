...
def load_data():
    ...
    # Índices: Ventas en 8, 10, 12... Alcances (%) en 9, 11, 13...
...
try:
    ...
    if dimension == "Performance Comercial":
        ...
        st.divider()
        # Análisis Individual (RESTAURADO)
        ...
        with col_r:
            ...
            # Evolución con Target (RESTAURADO)
            fig_evol = go.Figure()
        ...
        # Gráficos de Pie y Box (RESTAURADOS)
        st.divider()
        g1, g2 = st.columns(2)
        with g1: 
    ...
    # =========================================================
    # DIMENSIÓN: MATRIZ 9-BOX (INTERACTIVA Y COMPLETA)
    # =========================================================
        ...
        # Botones de Categoría (Restaurados)
        ...
        all_cols = cols_cat + cols_cat2 + cols_cat3
        cat_sel = None
        ...
        # FICHA TÉCNICA INTERACTIVA (Imagen 73c0a8)
        st.divider()
        v_f_sel = st.selectbox("🔎 Ver Ficha Técnica del Asesor:", ["-- Seleccione --"] + sorted(df_9['Vendedor'].unique()))
        
        if v_f_sel != "-- Seleccione --":
            v_f = df_9[df_9['Vendedor'] == v_f_sel].iloc[0]
